...
-- ----------------------------
INSERT INTO `pub_cart_setmeal` VALUES ('50', '10', '3', '1', '1513385656', null);
INSERT INTO `pub_cart_setmeal` VALUES ('49', '10', '2', '1', '1513385650', null);
INSERT INTO `pub_cart_setmeal` VALUES ('48', '10', '1', '1', '1513385619', '1513385621');
...
CREATE TABLE `pub_order_filter` (
  ...
  `device_id` int(11) unsigned NOT NULL COMMENT '关联的设备ID号',
  `user_id` int(11) unsigned NOT NULL COMMENT '关联的用户ID号',
  `express_id` int(11) unsigned NOT NULL COMMENT '关联快递信息ID号',
  ...
  `updated_at` int(11) NOT NULL COMMENT '订单修改时间',
  `is_pay` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '付款状态(0：未付款1：已付款)',
  `is_receipt` tinyint(1) unsigned zerofill DEFAULT '0' COMMENT '发货状态(0：未发货1：已发货)',
  `is_ship` tinyint(1) unsigned zerofill DEFAULT '0' COMMENT '收货状态(0：未收货1：已收货)',
  PRIMARY KEY (`id`),
  KEY `order_id` (`order_id`,`device_id`,`user_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
